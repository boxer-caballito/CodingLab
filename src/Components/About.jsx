...
function About() {
    ...
    return(
        ...
        <div className="containerAbout">
            ...
            <hr />
                <p className="parrafo">CodingLab es un sitio web educativo dedicado exclusivamente a enseñar programación de manera accesible, interactiva y gratuita. Desde principiantes hasta usuarios avanzados, nuestro objetivo es proporcionar recursos de alta calidad para aprender diversos lenguajes de programación y conceptos de desarrollo de software.</p>
